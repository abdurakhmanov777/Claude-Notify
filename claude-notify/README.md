...
- **Claude Notify: молчание при активности (вкл/выкл)** — включить/выключить пропуск пуша о завершении, когда вы работаете в VS Code. По умолчанию выключено; при включении команда каждый раз спрашивает, сколько **минут** бездействия требовать (по умолчанию 1, сохраняется в `idleSeconds` в секундах)
